    ...
    return (
        <main >
            <div className="lg:p-10 p-2 lg:pt-10 pt-5">
                <TopBar></TopBar>
                <div className="p-3 lg:px-10 pb-16 lg:pb-40 min-h-screen flex flex-col">
                    ...
                    <div className="block lg:hidden">
                        <Image
                            ...
                            width={1000}
                            alt="???"
                            className="rotate-3 rounded-full mx-auto lg:mx-0 max-w-[25rem]  mt-10"
                            loading="eager"
                        />
                        <div className=" mt-4">
                            ...
                            <div className="hover:underline">
                                <Link href={"https://www.reddit.com/user/Bubbly_Parfait_5823/"} className="flex gap-x-3">
                                    <svg
                                        ...
                                        className="octicon size-6 self-center text-[#7a7d86] hover:text-orange-500"
                                    >
                            ...
                            <div className="hover:underline">
                                <Link href={"https://www.youtube.com/@fobg-o5x"} className="flex gap-x-3">
                                    <svg
                                        ...
                                        height="24"
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="ipc-icon ipc-icon--youtube hover:text-red-500 size-6 self-center text-[#7a7d86]"
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                                        role="presentation"
                                    >
                        ...
                        <div className="pt-7 pb-10">
                            <div className="pt-7 border-t-[1px] border-[#000000] flex gap-x-3">
                                ...
                                <p className="text-white">dn606304@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:flex hidden w-full mt-24 gap-x-10">
                        ...
                        <div className="">
                            <Image
                                ...
                                width={1000}
                                alt="???"
                                className="rotate-3 rounded-full lg:max-w-[40rem] hidden lg:block"
                                loading="eager"
                            />
                            <div className="mt-8 space-y-5">
                                ...
                                <div className="hover:underline hover:text-purple-500">
                                    <Link href={"https://www.instagram.com/silvermladshiy/"} className="flex gap-x-3 hover:underline hover:text-purple-500">
                                        <svg viewBox="0 0 24 24" aria-hidden="true" className=" hover:fill-purple-500 h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"><path d="M12 3c-2.444 0-2.75.01-3.71.054-.959.044-1.613.196-2.185.418A4.412 4.412 0 0 0 4.51 4.511c-.5.5-.809 1.002-1.039 1.594-.222.572-.374 1.226-.418 2.184C3.01 9.25 3 9.556 3 12s.01 2.75.054 3.71c.044.959.196 1.613.418 2.185.23.592.538 1.094 1.039 1.595.5.5 1.002.808 1.594 1.038.572.222 1.226.374 2.184.418C9.25 20.99 9.556 21 12 21s2.75-.01 3.71-.054c.959-.044 1.613-.196 2.185-.419a4.412 4.412 0 0 0 1.595-1.038c.5-.5.808-1.002 1.038-1.594.222-.572.374-1.226.418-2.184.044-.96.054-1.267.054-3.711s-.01-2.75-.054-3.71c-.044-.959-.196-1.613-.419-2.185A4.412 4.412 0 0 0 19.49 4.51c-.5-.5-1.002-.809-1.594-1.039-.572-.222-1.226-.374-2.184-.418C14.75 3.01 14.444 3 12 3Zm0 1.622c2.403 0 2.688.009 3.637.052.877.04 1.354.187 1.67.31.421.163.72.358 1.036.673.315.315.51.615.673 1.035.123.317.27.794.31 1.671.043.95.052 1.234.052 3.637s-.009 2.688-.052 3.637c-.04.877-.187 1.354-.31 1.67-.163.421-.358.72-.673 1.036a2.79 2.79 0 0 1-1.035.673c-.317.123-.794.27-1.671.31-.95.043-1.234.052-3.637.052s-2.688-.009-3.637-.052c-.877-.04-1.354-.187-1.67-.31a2.789 2.789 0 0 1-1.036-.673 2.79 2.79 0 0 1-.673-1.035c-.123-.317-.27-.794-.31-1.671-.043-.95-.052-1.234-.052-3.637s.009-2.688.052-3.637c.04-.877.187-1.354.31-1.67.163-.421.358-.72.673-1.036.315-.315.615-.51 1.035-.673.317-.123.794-.27 1.671-.31.95-.043 1.234-.052 3.637-.052Z"></path><path d="M12 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6Zm0-7.622a4.622 4.622 0 1 0 0 9.244 4.622 4.622 0 0 0 0-9.244Zm5.884-.182a1.08 1.08 0 1 1-2.16 0 1.08 1.08 0 0 1 2.16 0Z"></path></svg>                                                  <p className="text-white text-md/10 self-center hover:text-purple-500">Follow on Instagram</p>
                                    </Link>
                                </div>
                                <div className="hover:underline hover:text-white">
                                    <Link href={"https://github.com/Silvqur"} className="flex gap-x-3">
                                ...
                                <div className="hover:underline hover:text-orange-500">
                                    <Link href={"https://www.reddit.com/user/Bubbly_Parfait_5823/"} className="flex gap-x-3">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                        ...
                                        >
                                            ...
                                            <path
                                                ...
                                                fill="currentColor"
                                            ></path>
                                        </svg>                                    <p className="text-white text-md/10 self-center hover:text-orange-500">Follow on Reddit</p>
                                    </Link>
                                </div>
                                <div className="hover:underline hover:text-red-500">
                                    <Link href={"https://www.youtube.com/@fobg-o5x"} className="flex gap-x-3">
                                        ...
                                        >
                                            <path d="M9.955 14.955v-5.91L15.182 12l-5.227 2.955zm11.627-7.769a2.505 2.505 0 0 0-1.768-1.768C18.254 5 12 5 12 5s-6.254 0-7.814.418c-.86.23-1.538.908-1.768 1.768C2 8.746 2 12 2 12s0 3.254.418 4.814c.23.86.908 1.538 1.768 1.768C5.746 19 12 19 12 19s6.254 0 7.814-.418a2.505 2.505 0 0 0 1.768-1.768C22 15.254 22 12 22 12s0-3.254-.418-4.814z"></path>
                                        </svg>                                    <p className="text-white text-md/10 self-center hover:text-red-500">Follow on YouTube</p>
                                    </Link>
                                </div>
                            </div>
                            <div className="pt-7">
