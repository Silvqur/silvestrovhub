...
export default function Home() {
  ...
  return (
    <main className="w-full">
      <div className="max-w-[80rem] mx-auto border-x-[1px] border-[#1726506c] lg:x-10 bg-[#090f1f6c] pb-5 lg:pb-14 p-1 lg:p-5">
        <TopBar></TopBar>
        <Image
          src={"/me.jpg"}
          height={5000}
          width={5000}
          alt="???"
          className="max-w-[6rem] rounded-full mt-14"
        />
        <div className="max-w-[50rem] mt-8 p-2 lg:p-6">
          <h1 className="text-white text-3xl/10">Software engineer, entrepreneur, and space enthusiast.</h1>
        ...
        <div className="z-40 overflow-x-auto flex gap-x-7 mt-5 lg:mt-16 p-5 ">
          <Image
            ...
            width={5000}
            alt="???"
            className="max-w-[15rem] rounded-xl rotate-2 mx-3 grayscale hover:filter-none"
          />
          <Image
            src={"/gilfoyle1.jpeg"}
            height={5000}
          ...
          <Image
            ...
            width={5000}
            alt="???"
            className="max-w-[15rem] rounded-xl rotate-6 mx-3 grayscale hover:filter-none"
          />
          <Image
            src={"/joe_keery.jpeg"}
            height={5000}
            width={5000}
            alt="???"
            className="max-w-[15rem] rounded-xl -rotate-1 mx-3 grayscale hover:filter-none"
          />
          <Image
            src={"/gilfoyle2.png"}
            height={5000}
          ...
          <Image
            ...
            width={5000}
            alt="???"
            className="max-w-[15rem] rounded-xl rotate-3 mx-3 grayscale hover:filter-none"
          />
          <Image
            src={"/google.jpeg"}
            height={5000}
