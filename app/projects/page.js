...
export default function Projects() {
    ...
    const data = [{ src: "/logo1.png", href: "https://svoyazemlyanow.vercel.app/", title: "Svoyazemlya", text: "We specialize in comprehensive groundwork solutions, delivering expert services from excavation to site preparation for various projects.", path: "svoyazemlyanow.vercel.app/" },]

    return (
        <main className="">
            <div className="lg:p-10 p-2 lg:pt-10 pt-5">
                <TopBar></TopBar>
                <div className="pt-10 px-3 lg:px-10 lg:pb-40 min-h-screen flex flex-col">
                    <div className="pt-10 ">
